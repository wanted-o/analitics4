...
class Google_Service_YouTube extends Google_Service {
	...
	public function __construct( Google_Client $client ) {
		...
		$this->channelSections = new Google_Service_YouTube_ChannelSections_Resource( $this, $this->serviceName, 'channelSections', array( 'methods' => array( 'delete' => array( 'path' => 'channelSections', 'httpMethod' => 'DELETE', 'parameters' => array( 'id' => array( 'location' => 'query', 'type' => 'string', 'required' => true ) ) ), 'insert' => array( 'path' => 'channelSections', 'httpMethod' => 'POST', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'onBehalfOfContentOwnerChannel' => array( 'location' => 'query', 'type' => 'string' ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ) ) ), 'list' => array( 'path' => 'channelSections', 'httpMethod' => 'GET', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ), 'channelId' => array( 'location' => 'query', 'type' => 'string' ), 'id' => array( 'location' => 'query', 'type' => 'string' ), 'mine' => array( 'location' => 'query', 'type' => 'boolean' ) ) ), 'update' => array( 'path' => 'channelSections', 'httpMethod' => 'PUT', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ) ) ) ) ) );
		$this->channels = new Google_Service_YouTube_Channels_Resource( $this, $this->serviceName, 'channels', array( 'methods' => array( 'list' => array( 'path' => 'channels', 'httpMethod' => 'GET', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'managedByMe' => array( 'location' => 'query', 'type' => 'boolean' ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ), 'forUsername' => array( 'location' => 'query', 'type' => 'string' ), 'mine' => array( 'location' => 'query', 'type' => 'boolean' ), 'maxResults' => array( 'location' => 'query', 'type' => 'integer' ), 'id' => array( 'location' => 'query', 'type' => 'string' ), 'pageToken' => array( 'location' => 'query', 'type' => 'string' ), 'mySubscribers' => array( 'location' => 'query', 'type' => 'boolean' ), 'categoryId' => array( 'location' => 'query', 'type' => 'string' ) ) ), 'update' => array( 'path' => 'channels', 'httpMethod' => 'PUT', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ) ) ) ) ) );
		...
		$this->playlists = new Google_Service_YouTube_Playlists_Resource( $this, $this->serviceName, 'playlists', array( 'methods' => array( 'delete' => array( 'path' => 'playlists', 'httpMethod' => 'DELETE', 'parameters' => array( 'id' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ) ) ), 'insert' => array( 'path' => 'playlists', 'httpMethod' => 'POST', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'onBehalfOfContentOwnerChannel' => array( 'location' => 'query', 'type' => 'string' ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ) ) ), 'list' => array( 'path' => 'playlists', 'httpMethod' => 'GET', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ), 'onBehalfOfContentOwnerChannel' => array( 'location' => 'query', 'type' => 'string' ), 'channelId' => array( 'location' => 'query', 'type' => 'string' ), 'mine' => array( 'location' => 'query', 'type' => 'boolean' ), 'maxResults' => array( 'location' => 'query', 'type' => 'integer' ), 'pageToken' => array( 'location' => 'query', 'type' => 'string' ), 'id' => array( 'location' => 'query', 'type' => 'string' ) ) ), 'update' => array( 'path' => 'playlists', 'httpMethod' => 'PUT', 'parameters' => array( 'part' => array( 'location' => 'query', 'type' => 'string', 'required' => true ), 'onBehalfOfContentOwner' => array( 'location' => 'query', 'type' => 'string' ) ) ) ) ) );
