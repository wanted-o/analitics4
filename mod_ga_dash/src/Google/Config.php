...
class Google_Config {
	...
	public function __construct( $ini_file_location = null ) {
		$this->configuration = array( 
			...
			'auth_class' => 'Google_Auth_OAuth2', 'io_class' => self::USE_AUTO_IO_SELECTION, 'cache_class' => 'Google_Cache_File', 
			...
			'classes' => array( 'Google_IO_Abstract' => array( 'request_timeout_seconds' => 100 ), 'Google_Http_Request' => array( 
				...
				'Google_Auth_OAuth2' => array( 
					...
					// Other parameters.
					'access_type' => 'online', 'approval_prompt' => 'auto', 'request_visible_actions' => '', 'federated_signon_certs_url' => 'https://www.googleapis.com/oauth2/v1/certs' ), 
				// Set a default directory for the file cache.
				'Google_Cache_File' => array( 'directory' => sys_get_temp_dir() . '/Google_Client' ) ), 
